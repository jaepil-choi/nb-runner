"""
Multi-Period Momentum Strategy Configuration

Configuration parameters for the multi-period momentum strategy.
"""
...
# Time periods for momentum calculation (in hours, converted to minutes)
hours = [1, 3, 6]
...
system_config = {
    ...
    "new_data_window": 360,  # The window value for fetching the latest data (max minutes from strategy)
